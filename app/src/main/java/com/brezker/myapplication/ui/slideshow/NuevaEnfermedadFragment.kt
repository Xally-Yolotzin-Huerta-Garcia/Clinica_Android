...
import com.brezker.myapplication.databinding.FragmentNuevaEnfermedadBinding
...
//private lateinit var binding: FragmentNuevaEnfermedadBinding
 ...
 */
class NuevaEnfermedadFragment : Fragment() {
    // TODO: Rename and change types of parameters
    private var json_enfermedad: String? = null
    private var param2: String? = null

    private var _binding: FragmentNuevaEnfermedadBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentNuevaEnfermedadBinding.inflate(inflater, container, false)
    ...
    fun guardarDatos() {
        ...
        val request = Request.Builder()
            ...
            .url("http://192.168.100.19:8000/api/enfermedad")
            .post(formBody)
            .build()
    ...
    fun eliminarDatos(){
        ...
        val request = Request.Builder()
            //.url("http://yourip:8000/api/enfermedad")
            .url("http://192.168.100.19:8000/api/enfermedad/delete")
            .post(formBody)
            .build()
        client.newCall(request).enqueue(object : Callback {
            override fun onFailure(call: Call, e: IOException) {
    ...
    companion object {
         ...
         * @return A new instance of fragment NuevaEnfermedadFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            NuevaEnfermedadFragment().apply {
